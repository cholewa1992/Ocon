...
We have established our opinion that the online tools today lack the presence of the whiteboard which is important. If you are able to maintain a physical Scrumboard, another problem surfaces. However there is one great point where the whiteboard is lacking; It's Analog. Maintaining the data is all manual translation form the board to a spreadsheet or the likes.
...
The Contextaware Scrumboard consists of three parts: The Widget, The Central and the Scrumboard. These parts are in our case distributed and communicate by the TcpHelper implemented for the framework.

\paragraph{The Widget}

\paragraph{The Central}

\paragraph{The Scrumboard}
